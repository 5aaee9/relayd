...
pub const Metrics = struct {
    ...
    udp_worker_packets_in_total: Counter = .{},
    udp_worker_packets_out_total: Counter = .{},
    udp_worker0_packets_in_total: Counter = .{},
    udp_worker1_packets_in_total: Counter = .{},
    udp_worker2_packets_in_total: Counter = .{},
    udp_worker3_packets_in_total: Counter = .{},
    udp_worker0_packets_out_total: Counter = .{},
    udp_worker1_packets_out_total: Counter = .{},
    udp_worker2_packets_out_total: Counter = .{},
    udp_worker3_packets_out_total: Counter = .{},
    udp_dataplane_redesign_packets_in_total: Counter = .{},
    udp_dataplane_redesign_packets_out_total: Counter = .{},
    udp_io_uring_submit_total: Counter = .{},
    udp_io_uring_cqe_total: Counter = .{},
    udp_io_uring_multishot_total: Counter = .{},
    udp_io_uring_buf_release_total: Counter = .{},
    udp_io_uring_fallback_total: Counter = .{},
    udp_fast_path_packets_in_total: Counter = .{},
    udp_fast_path_packets_out_total: Counter = .{},
    udp_fast_path_gso_send_total: Counter = .{},
    udp_fast_path_gro_recv_total: Counter = .{},
    udp_fast_path_fallback_total: Counter = .{},
    udp_fast_path_drop_total: Counter = .{},
